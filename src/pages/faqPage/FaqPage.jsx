...
const FaqPage = () => {
    ...
    return (
        <div className="faq">
            ...
            <p></p>
            <p>Aristotle said, "Adventure is worthwhile!" We hope you feel the same and that you will enjoy having a place to document, share, and plan your adventures with GOAT! </p>
            <div>
